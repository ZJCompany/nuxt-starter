...
function getAllDependencies(ids, rendererContext) {
  ...
  for (const id of ids) {
    ...
    const isDynamic = (_a = rendererContext.clientManifest[id]) == null ? void 0 : _a.isDynamicEntry;
    if (isDynamic) {
    ...
    for (const dynamicDepId of ((_b = rendererContext.clientManifest[id]) == null ? void 0 : _b.dynamicImports) || []) {
